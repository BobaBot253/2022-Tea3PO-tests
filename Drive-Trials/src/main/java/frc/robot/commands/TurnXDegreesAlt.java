...
public class TurnXDegreesAlt implements Command {
    ...
    */
    public TurnXDegreesAlt(double degrees, double angVel, double angAcc) {
        turnController = new PIDController(
            DrivetrainConstants.tkP, 
            DrivetrainConstants.tkI, 
            DrivetrainConstants.tkD
        );
        degrees %= 360;
